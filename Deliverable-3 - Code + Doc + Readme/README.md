...
A lightweight, mobile-first AI image editor prototype built for  "Re-Imagining Photoshop - The AI Editor of 2030" . Our solution combines **conversational AI editing**, **real-time 3D parallax effects**, **interactive day/night transformations**, and **voice-controlled workflows** - all optimized for low-compute devices.
...
```bash
git clone https://github.com/<UN>/Submission.git
cd Submission
```
